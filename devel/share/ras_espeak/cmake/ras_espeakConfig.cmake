...
if("TRUE" STREQUAL "TRUE")
  set(ras_espeak_SOURCE_PREFIX /home/ras29/catkin_ws/src/ras_project/ras_espeak)
  set(ras_espeak_DEVEL_PREFIX /home/ras29/catkin_ws/devel)
  ...
  set(ras_espeak_INSTALL_PREFIX /home/ras29/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Francisco Viña <fevb@kth.se>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ras_espeak' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ras_espeak' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ras29/catkin_ws/src/ras_project/ras_espeak/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ras_espeak_dep}_FOUND)
      find_package(${ras_espeak_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ras_espeak_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
