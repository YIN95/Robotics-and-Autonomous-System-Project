...
if("TRUE" STREQUAL "TRUE")
  set(realsense_camera_SOURCE_PREFIX /home/ras19/catkin_ws/src/ras_project/ras_realsense/realsense_camera)
  set(realsense_camera_DEVEL_PREFIX /home/ras19/catkin_ws/devel)
  ...
  set(realsense_camera_INSTALL_PREFIX /home/ras19/catkin_ws/install)
...
if(NOT "/home/ras19/catkin_ws/devel/include;/home/ras19/catkin_ws/src/ras_project/ras_realsense/realsense_camera/include " STREQUAL " ")
  set(realsense_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/ras19/catkin_ws/devel/include;/home/ras19/catkin_ws/src/ras_project/ras_realsense/realsense_camera/include")
  ...
  elseif(NOT "http://www.ros.org/wiki/RealSense " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Itay Carpis <itay.carpis@intel.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ras19/catkin_ws/src/ras_project/ras_realsense/realsense_camera/${idir}'.  ${_report}")
    endif()
...
set(realsense_camera_EXPORTED_TARGETS "realsense_camera_generate_messages_cpp;realsense_camera_generate_messages_eus;realsense_camera_generate_messages_lisp;realsense_camera_generate_messages_nodejs;realsense_camera_generate_messages_py;realsense_camera_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${realsense_camera_dep}_FOUND)
      find_package(${realsense_camera_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${realsense_camera_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
