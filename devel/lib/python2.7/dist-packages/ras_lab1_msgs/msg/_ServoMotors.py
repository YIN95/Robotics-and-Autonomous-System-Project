...
"""autogenerated by genpy from ras_lab1_msgs/ServoMotors.msg. Do not edit."""
import sys
...
class ServoMotors(genpy.Message):
  ...
  _type = "ras_lab1_msgs/ServoMotors"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.servo1))
      _x = self.servoangle
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.servo1,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 8
