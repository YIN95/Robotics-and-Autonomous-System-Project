...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B4i().pack(_x.pause, _x.pan_servo_index, _x.tilt_servo_index, _x.sensor_index, _x.no_of_sensors))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pause, _x.pan_servo_index, _x.tilt_servo_index, _x.sensor_index, _x.no_of_sensors,) = _get_struct_B4i().unpack(str[start:end])
      ...
      (_x.speed, _x.acceleration, _x.pan_position_left, _x.pan_position_right, _x.pan_position_left_angle_degrees, _x.pan_position_right_angle_degrees, _x.tilt_position_up, _x.tilt_position_down, _x.tilt_position_up_angle_degrees, _x.tilt_position_down_angle_degrees, _x.tilt_steps, _x.cycle_time_sec,) = _get_struct_10fif().unpack(str[start:end])
      return self
...
def _get_struct_B4i():
    ...
    return _struct_B4i
_struct_10fif = None
def _get_struct_10fif():
    global _struct_10fif
    if _struct_10fif is None:
        _struct_10fif = struct.Struct("<10fif")
    return _struct_10fif
# This Python file uses the following encoding: utf-8
