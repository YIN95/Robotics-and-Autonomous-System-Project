...
class PathPublisher:
    ...
    def __init__(self, visibility_graph):
        ...
        self.sub_pose = rospy.Subscriber('/pose', Pose2D, self.pose_callback)
        self.sub_global_desired_pose = rospy.Subscriber('/global_desired_pose', Pose2D,
                                                   self.global_desired_pose_callback)
    ...
    def global_desired_pose_callback(self, desired_pose):
    ...
    def find_path(self):
        ...
        vertex_path = self.graph.shortest_path(self.position, self.desired_position)
        path = []
