...
;//! \htmlinclude PathList.msg.html

(cl:defclass <PathList> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass PathList (<PathList>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PathList>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PathList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gp9_path_planning-msg:<PathList> is deprecated: use gp9_path_planning-msg:PathList instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PathList>))
...
(cl:defmethod list-val ((m <PathList>))
  ...
  (list m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PathList>) ostream)
  "Serializes a message object of type '<PathList>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PathList>) istream)
  "Deserializes a message object of type '<PathList>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PathList>)))
  "Returns string type for a message object of type '<PathList>"
  "gp9_path_planning/PathList")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PathList)))
  "Returns string type for a message object of type 'PathList"
  "gp9_path_planning/PathList")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PathList>)))
  "Returns md5sum for a message object of type '<PathList>"
  "73778bfb1ad292de1879ee4eba0deb12")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PathList)))
  "Returns md5sum for a message object of type 'PathList"
  "73778bfb1ad292de1879ee4eba0deb12")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PathList>)))
  "Returns full string definition for message of type '<PathList>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PathList)))
  "Returns full string definition for message of type 'PathList"
  (cl:format cl:nil "Header header~%geometry_msgs/Pose2D[] list~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <PathList>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PathList>))
